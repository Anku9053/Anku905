  ...
  return (
    ...
    <div className='contact' id='contact'>
      ...
      <div className='contact-part'>
        ...
        <p><IoCall style={{marginTop:'2px'}} /><a href='/'>+91 8287670719</a></p>
          <p><HiOutlineMail style={{marginTop:'2px'}} /><a href="mailto:ankesh9053@gmail.com" target='_blank'>ankesh9053@gmail.com</a></p>
          <p><BsLinkedin style={{marginTop:'2px'}} /><a href="https://www.linkedin.com/in/ankesh-kumar-591595257/" target='_blank'>https://www.linkedin.com/in/ankesh-kumar-591595257/</a></p>
          <p><AiFillGithub style={{marginTop:'2px'}} /><a href="https://github.com/Anku9053" target='_blank'>https://github.com/Anku9053</a></p>
        </div>
      </div>
